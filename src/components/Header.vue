...
defineEmits(['decrementar-cantidad', 'incrementar-cantidad', 'eliminar-producto', 'vaciar-carrito', 'agregar-carrito'])
                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            <!-- Se coloca v-if porque es una condición -->
                            ...
                            <div v-else>
                                ...
                                <button class="btn btn-dark w-100 mt-3 p-2" @click="$emit('vaciar-carrito')">Vaciar Carrito
                                </button>
                            </div>
                        </div>
                    </div>
